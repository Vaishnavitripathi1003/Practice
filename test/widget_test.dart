      ...
      for (var feature in data['features']) {
        ...
        tempPolygons.add(
          Polygon(
            ...
            fillColor: Colors.blueAccent,// Make the polygon transparent to see the map
            onTap: () {
...
class PolygonOverlayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) async {
    ...
    for (var i = 0; i < polygonPoints.length; i++) {
      ...
      final screenCoordinate = await mapController.getScreenCoordinate(point);
      final pixelPoint = Offset(screenCoordinate.x.toDouble(), screenCoordinate.y.toDouble());
